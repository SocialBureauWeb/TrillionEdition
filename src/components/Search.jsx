...
const Search = () => {
  ...
  return (
    <StyledWrapper>
      <div className="input">
        <svg className="svg" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" onClick={handleClick}>
          {/* ... SVG paths unchanged ... */}
          <path
            fillRule="evenodd"
            clipRule="evenodd"
        ...
        {isExpanded && (
          <input className="search" type="text" placeholder="What can I help you with?" />
        )}
      </div>
    </StyledWrapper>
  );
...
const StyledWrapper = styled.div`
  ...
  bottom: 5rem;
  z-index: 9999;
  /* Add a subtle drop shadow for visibility */
  ...
  .search {
    ...
    background:
      linear-gradient(120deg, #8B0000, hsl(35, 81%, 73%)) border-box;
