    ...
    <StyledWrapper>
      <div className="card">
        ...
        <div className="content">
          <div className="logo">
            <div className="logo1">
  <img src='assets/socialbureaulogo.png' id='logo-main' alt='logo'/>
</div>
...
const StyledWrapper = styled.div`
  ...
  @keyframes trail {
    0% {
      background: linear-gradient(90deg, rgba(255, 255, 255, 0) 90%, #ec2024 100%);
      opacity: 0;
    }

    30% {
      background: linear-gradient(90deg, rgba(255, 255, 255, 0) 70%, #ec2024 100%);
      opacity: 1;
    }
